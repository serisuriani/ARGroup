  ...
  const start = async () => {
    try {
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "./assets/targets/dress1.mind",
      });
      ...
      const gltf = await loadGLTF("./assets/models/dress1/scene.gltf");
      ...
      const audio = await loadAudio("./assets/sounds/dress1.mp3");
