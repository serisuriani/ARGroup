  ...
  const start = async () => {
    try {
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "./assets/targets/dress3.mind",
      });
      ...
      const gltf = await loadGLTF("./assets/models/dress3/scene.gltf");
      ...
      const audio = await loadAudio("./assets/sounds/dress3.mp3");
